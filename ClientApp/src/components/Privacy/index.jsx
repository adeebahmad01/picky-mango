  ...
  return (
    <div>
      <div className="container py-5">
        <H2 variant="h1">Privacy Policy</H2>
        <Paper elevation={2} className="p-3 my-3">
          <p>
            Picky Mango built the Picky Mango app as a Commercial app. This
            SERVICE is provided by Picky Mango and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Picky Mango unless
        ...
        <Paper elevation={2} className="p-3 my-3">
          ...
          <p>
            ...
            including but not limited to Picky Mango. The information that we
        ...
        <Paper elevation={2} className="p-3 my-3">
          ...
          <p>This policy is effective as of 2021-04-30</p>
        </Paper>
        <Paper elevation={2} className="p-3 my-3">
          <H2>Contact Us</H2>
          <p>
